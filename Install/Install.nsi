...
!define PRODUCT_NAME "LookingForHappiness"
!define PRODUCT_VERSION "v0.0.1"
!define PRODUCT_PUBLISHER "KangLin studio"
!define PRODUCT_WEB_SITE "https://github.com/KangLin/LookingForHappiness"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\LookingForHappiness.exe"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\LookingForHappiness"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\LookingForHappiness.exe"
...
LangString LANG_PRODUCT_NAME ${LANG_ENGLISH} "LookingForHappiness"
...
OutFile "LookingForHappiness-Setup-${PRODUCT_VERSION}.exe"
...
Section "${PRODUCT_NAME}" SEC01
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\$(LANG_PRODUCT_NAME).lnk" "$INSTDIR\LookingForHappiness.exe"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\uninst.exe"
  CreateShortCut "$DESKTOP\$(LANG_PRODUCT_NAME).lnk" "$INSTDIR\LookingForHappiness.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\LookingForHappiness.exe"
  call InstallFont
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\LookingForHappiness.exe"
